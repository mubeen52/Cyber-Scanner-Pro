	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'pulse-glow': {
					'0%, 100%': { 
						boxShadow: '0 0 20px hsl(120 100% 50% / 0.4), 0 0 40px hsl(120 100% 50% / 0.2), 0 0 80px hsl(120 100% 50% / 0.1)',
						filter: 'brightness(1)'
					},
					'50%': { 
						boxShadow: '0 0 30px hsl(120 100% 50% / 0.6), 0 0 60px hsl(120 100% 50% / 0.4), 0 0 120px hsl(120 100% 50% / 0.2)',
